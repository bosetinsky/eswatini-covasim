...
scenarios = {'baseline': {
             ...
             'Scenario4': {
              'name':'Restarting both',
              'pars': {
                  'interventions': [
                                    cv.change_beta(days=interv_day1, changes=interv_eff_60, layers='c'), 
                                    cv.change_beta([interv_day1, interv_day2, interv_day3, interv_day4, w_open], [0.4, 0.6, 0.4, 0.4 , 0.95], layers='w'),                                    
