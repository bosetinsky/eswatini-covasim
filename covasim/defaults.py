...
# Default age data, based on Eswatini population deaggregation 2017-- used in population.py
default_age_data = np.array([
            ...
            [70, 74, 0.013],
            [75, 79, 0.009], 
            [80, 84, 0.005],# Calculated based on 0.08 total for >=80
...
def get_scen_plots():
    ...
    plots = sc.odict({
        ...
        'Number of Active Symptomatic Cases': [
            'n_symptomatic',
        ],
        'Cumulative Mortality': [
            'cum_deaths',
        ],
        'Number of people requiring ICU': [
            'n_critical',
        ],
